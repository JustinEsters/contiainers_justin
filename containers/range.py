def range(a, b=None, c=None):
    ...
    behave exactly like the built-in range function.
    For example:
    ...
    range object is written in the C
    ...
    It is very common for C programs to be 100x
    longer than their corresponding python programs.
    ...
    corresponding python code because it ca
