...
class NormalizedStr:
    ...
    False
    The two strings to the right of the
    in keyword above are equal
    *semantically*,
    ...
    def __repr__(self):
        ...
        function should be valid python
        code
    ...
    def __contains__(self, substr):
        ...
        '''
        n_sub = unicodedata.normalize(self.normal_form, substr)
        return n_sub in self.text
