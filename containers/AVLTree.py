'''
his file implements the AVL Tree data structure.
...
class AVLTree(BST):
    ...
    def _left_rotate(node):
        ...
        The textbook's class hierarchy
        for their AVL tree code is fairly different from our class hierarchy,
    ...
    def _right_rotate(node):
        ...
        The lecture videos provide a high-level overview of tree rotations,
        and the textbook provides full python code.
        The textbook's class hierarchy for
        their AVL tree code is fairly different from our class hierarchy,
        however, so you will have to adapt their code.
        '''
        if node is None:
            return node
    ...
    def insert(self, value):
        ...
        HINT:
        It is okay to
        add @staticmethod helper functions for this code.
        The code should look very similar to the code
        for your insert function for the BST,
        but it will also
        call the left and right rebalancing functions.
        '''
        if self.root:
